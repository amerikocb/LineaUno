...
namespace VLP.ConfigureServices.NeedfulClasses.AutoMapper
{
    ...
    {
        public static IList<Map> LoadStandardMappings(Assembly rootAssambly)
        {
            var types = rootAssambly.GetExportedTypes();
